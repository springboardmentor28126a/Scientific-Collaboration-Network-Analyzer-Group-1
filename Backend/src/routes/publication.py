...
def check_publication_write_permission(db: Session, pub, current_user: User):
    ...
    # InstitutionAdmin has full access if uploader is in same institution
    ...
    # Co-authors have permission to modify
    ...
    raise HTTPException(status_code=403, detail="You do not have permission to modify this publication.")
