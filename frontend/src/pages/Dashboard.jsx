...
const Dashboard = () => {
  ...
  const researcherCards = [
    ...
    ['H-index', stats?.h_index, 'bi-graph-up', '/profile'], ['Active projects', stats?.active_projects || 0, 'bi-folder2-open', '/profile'],
  ];
  ...
  const adminCards = [['Institution publications', stats?.publications_count, 'bi-journal-text', '/publications'], ['Active researchers', stats?.researchers_count, 'bi-people', '/researchers'], ['Collaborations', stats?.collaboration_count, 'bi-diagram-3', '/researchers'], ['Active projects', stats?.active_projects || 0, 'bi-folder2-open', '/conferences']];
  ...
  return <div className="container py-5">
    ...
    <div className="col-md-4"><div className="card"><div className="card-body"><h5>Quick actions</h5><Link className="btn btn-outline-primary btn-sm me-2 mb-2" to="/profile">My profile</Link><Link className="btn btn-outline-primary btn-sm me-2 mb-2" to="/publications">Publications</Link><Link className="btn btn-outline-primary btn-sm mb-2" to="/conferences">Conferences</Link></div></div></div></div>
  </div>;
};
